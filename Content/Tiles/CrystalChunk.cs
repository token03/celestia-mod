...
namespace Celestia.Content.Tiles
{
	public class CrystalChunk : ModTile
	{
	...
	public class CelestiaOreSystem : ModSystem
	{
		public static LocalizedText CelestiaOrePassMessage { get; private set; }

		public override void SetStaticDefaults()
		{
			CelestiaOrePassMessage = Language.GetOrRegister(Mod.GetLocalizationKey($"WorldGen.{nameof(CelestiaOrePassMessage)}"));
		}
		...
		public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight)
		{
			...
			if (ShiniesIndex != -1)
			{
				...
				tasks.Insert(ShiniesIndex + 1, new CrystalChunkPass("Crystal Chunks", 237.4298f));
			}
		}
	}

	public class CrystalChunkPass : GenPass
	{
		public CrystalChunkPass(string name, float loadWeight) : base(name, loadWeight)
		{
		}

		protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
		{
			progress.Message = CelestiaOreSystem.CelestiaOrePassMessage.Value;
			...
			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); k++)
			{
				...
				WorldGen.TileRunner(x, y, WorldGen.genRand.Next(3, 6), WorldGen.genRand.Next(2, 6), ModContent.TileType<CrystalChunk>());
